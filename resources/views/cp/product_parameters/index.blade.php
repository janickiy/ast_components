                            ...
                            <div class="card-body">
                                <div class="pb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <a href="{{ route('admin.product_parameters.create', ['product_id' => $product_id]) }}"
            ...
            <script>
                ...
                $(function (){
                    ...
                    $("#itemList").DataTable({
                        ...
                        'serverSide': true,
                        'ajax': {
                            url: '{{ route('admin.datatable.product_parameters', ['product_id' => $product_id]) }}'
                        },
                        'columns': [
                            {data: 'name', name: 'name'},
                    ...
                    $('#itemList').on('click', 'a.deleteRow', function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    url: '{{ route('admin.product_parameters.destroy') }}',
                                    type: "POST",
                                    dataType: "html",
                                    data: {id: rowid},
