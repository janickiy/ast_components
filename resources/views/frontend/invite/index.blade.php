...
@section('content')
    ...
    <div class="invite container-xs">
        ...
        {!! Form::open(['url' => route('frontend.invite.store'), 'method' => 'post', 'class' => 'invite__form is-success']) !!}
        ...
        <div class="invite__input-row">
            <div class="invite__input-col">
                ...
                <div class="form-input">
                    ...
                    {!! Form::text('company', old('company', $user?->company->name ?? null), ['id' => 'invite-company', 'placeholder' => 'ООО "Электромонтаж"', 'required']) !!}
                ...
                <div class="form-input">
                    ...
                    {!! Form::text('name', old('name', $user->name ?? null), ['id' => 'name', 'placeholder' => 'Иванов Иван', 'required']) !!}
                    @if ($errors->has('name'))
                ...
                <div class="form-input">
                    ...
                    {!! Form::email('email', old('email', $user->email ?? null), ['id' => 'invite-email', 'placeholder' => 'customer@gmail.com', 'required']) !!}
                    @if ($errors->has('email'))
                ...
                <div class="form-input">
                    ...
                    {!! Form::tel('phone', old('phone', $user->phone ?? null), ['id' => 'invite-phone', 'placeholder' => '+7 900 000-00-00', 'required']) !!}
                    @if ($errors->has('phone'))
        ...
        <div class="invite__checkbox form-checkbox">
            <input type="checkbox" name="agreement" id="invite-agreement">
