...
class Catalog extends Model
{
    ...
    public static function getCatalogsRaw()
    {
        return Cache::remember('catalogs_raw', 60 * 60, function ()
        {
    ...
    {
        return Cache::remember('catalog_total_products_' . $this->id, 60 * 60, function ()
        {
            $allChildren = [$this->id];

            self::getAllChildren(self::getCatalogsRaw(), $allChildren, $this->id);
