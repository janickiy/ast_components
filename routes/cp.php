...
Route::group(['prefix' => 'goods'], function () {
    ...
    Route::group(['prefix' => 'catalog'], function () {
        ...
        Route::get('create/{parent_id?}', [CatalogController::class, 'create'])->name('admin.catalog.create')->where('parent_id', '[0-9]+')->middleware(['permission:admin|moderator']);
...
Route::group(['prefix' => 'seo'], function () {
    Route::middleware(['permission:admin|moderator'])->group(function () {
        ...
        Route::group(['prefix' => 'redirect'], function () {
            ...
            Route::post('store', [RedirectController::class, 'store'])->name('admin.redirect.store');
            Route::get('edit/{id}', [RedirectController::class, 'edit'])->name('admin.redirect.edit')->where('id', '[0-9]+');
            Route::put('update', [RedirectController::class, 'update'])->name('admin.redirect.update');
            Route::post('destroy', [RedirectController::class, 'destroy'])->name('admin.redirect.destroy');
        });
    });
});
